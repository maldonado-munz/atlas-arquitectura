...
export const I18N_TEXTS = {
  es: {
    ...
    searchPlaceholder: 'Buscar por obra, arquitecto, colaboradores, institución, material...',
    architect: 'Arquitecto',
    allArchitects: 'Todos los arquitectos',
    leadArchitect: 'Arquitecto Principal',
    responsibleArchitect: 'Arquitecto y Oficina',
    collaborators: 'Colaboradores',
    collaboratorsLabel: 'Colaboradores del Proyecto',
    institutions: 'Instituciones Asociadas',
    institutionsLabel: 'Instituciones y Entidades',
    country: 'País',
    ...
    allMainPrograms: 'Todos los programas principales',
    specificProgram: 'Programa Específico',
    allSpecificPrograms: 'Todos los programas específicos',
    period: 'Período',
  ...
  en: {
    ...
    searchPlaceholder: 'Search by project, architect, collaborators, institution, material...',
    architect: 'Architect',
    allArchitects: 'All architects',
    leadArchitect: 'Lead Architect',
    responsibleArchitect: 'Architect & Office',
    collaborators: 'Collaborators',
    collaboratorsLabel: 'Project Collaborators',
    institutions: 'Associated Institutions',
    institutionsLabel: 'Institutions & Entities',
    country: 'Country',
    ...
    allMainPrograms: 'All main programs',
    specificProgram: 'Specific Program',
    allSpecificPrograms: 'All specific programs',
    period: 'Period',
